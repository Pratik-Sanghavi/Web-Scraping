...
class Booking(webdriver.Chrome):
    def __init__(self, driver_path = r'C:/Users/sangh/Desktop/Drivers/ChromeDriver', teardown=True):
    ...
    def select_adults(self, count):
        ...
        while True:
            ...
            #If the value of adults reaches 1 start incrementing
    ...
    def report_results(self):
        ...
        datetime_convert = str(datetime.now()).replace(':','-').replace('.','-').replace('-','_')
        with open(f'./Results/Hotel_Prices_{datetime_convert}.txt','w+') as file:
